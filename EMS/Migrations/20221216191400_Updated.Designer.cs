...
namespace EMS.Migrations
{
    ...
    [Migration("20221216191400_Updated")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EMS.Models.AssignedTicket", b =>
                {
                    b.Property<int>("AssignedTicketsId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("AssignedTicketsId"), 1L, 1);
            ...
            modelBuilder.Entity("EMS.Models.ReturnedAsset", b =>
                {
            ...
            modelBuilder.Entity("EMS.Models.AssignedTicket", b =>
                {
                    ...
                    b.HasOne("EMS.Models.Ticket", "Ticket")
                        .WithMany()
            ...
            modelBuilder.Entity("EMS.Models.ReturnedAsset", b =>
                {
                    ...
                    b.HasOne("EMS.Models.Asset", "Asset")
                        .WithMany()
            ...
            modelBuilder.Entity("EMS.Models.ReturnedSystem", b =>
                {
                    ...
                    b.HasOne("EMS.Models.BuildSystem", "BuildSystem")
                        .WithMany()
                        .HasForeignKey("buildsystemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
